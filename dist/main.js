...
gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4__["ScrollTrigger"], gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_5__["ScrollToPlugin"]);
...
jquery__WEBPACK_IMPORTED_MODULE_1__(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1__('.mobile__burger').on('click', function () {
...
window.onload = function () {
  var content = jquery__WEBPACK_IMPORTED_MODULE_1__(".intro__content");
  var video = jquery__WEBPACK_IMPORTED_MODULE_1__(".intro__video");
  var stats = jquery__WEBPACK_IMPORTED_MODULE_1__(".stats")[0];
  ...
  if (window.innerWidth > 866) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(video, {
      duration: 1.5,
      right: "0px",
      ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power1"].easeInOut
    });
    gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].from(jquery__WEBPACK_IMPORTED_MODULE_1__(".project-tool__element"), {
      scrollTrigger: {
        trigger: jquery__WEBPACK_IMPORTED_MODULE_1__(".project-tool__content"),
        start: "20px 80%",
    ...
    gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].from(stats, {
      scrollTrigger: {
        trigger: stats,
        start: "20px 80%"
      },
  ...
  var businessEnd = jquery__WEBPACK_IMPORTED_MODULE_1__("#business").text();
  var downloadsEnd = jquery__WEBPACK_IMPORTED_MODULE_1__("#downloads").text();
  var installsEnd = jquery__WEBPACK_IMPORTED_MODULE_1__("#installs").text();
  var usersEnd = jquery__WEBPACK_IMPORTED_MODULE_1__("#users").text();
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(startScore, {
    scrollTrigger: stats,
    duration: 5,
    score: businessEnd,
    roundProps: "score",
    ...
    onUpdate: function onUpdate() {
      jquery__WEBPACK_IMPORTED_MODULE_1__("#business").text(startScore.score);
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(startScore, {
    scrollTrigger: stats,
    ...
    ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power1"].easeInOut,
    onUpdate: function onUpdate() {
      jquery__WEBPACK_IMPORTED_MODULE_1__("#downloads").text(startScore.score);
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(startScore, {
    scrollTrigger: stats,
    ...
    ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power1"].easeInOut,
    onUpdate: function onUpdate() {
      jquery__WEBPACK_IMPORTED_MODULE_1__("#installs").text(startScore.score);
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(startScore, {
    scrollTrigger: stats,
    ...
    ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power1"].easeInOut,
    onUpdate: function onUpdate() {
      jquery__WEBPACK_IMPORTED_MODULE_1__("#users").text(startScore.score);
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].utils.toArray(".mobile__link").forEach(function (a) {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].utils.toArray(".footer__nav a").forEach(function (a) {
    a.addEventListener("click", function (e) {
      e.preventDefault();
      gsap__WEBPACK_IMPORTED_MODULE_3__["gsap"].to(window, {
        duration: 1.5,
...
function toggleBtnUp() {
  var btnUp = jquery__WEBPACK_IMPORTED_MODULE_1__(".button-up");

  if (jquery__WEBPACK_IMPORTED_MODULE_1__(window).scrollTop() > 200) {
    btnUp.addClass("show");
  } else {
